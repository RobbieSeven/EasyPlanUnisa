...
public class TestAggiungiEsameEsistente {
	...
	public static void main(String[] args) {
	    ...
	    //Curriculum di Cloud Computing
	      ...
	      driver.findElement(By.xpath("/html/body/div[1]/div/fieldset[1]/fieldset[1]/div/div/form[3]/button")).click();
	      
	      driver.findElement(By.xpath("/html/body/div[2]/form/input[8]")).click();
	      
	      driver.findElement(By.xpath("/html/body/div[2]/form/input[8]")).sendKeys("5");
