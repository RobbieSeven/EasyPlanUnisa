 ...
 */
@WebServlet("/GestioneGruppoEsamiOpzionali")
public class GestioneGruppoEsamiOpzionali extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GestioneGruppoEsamiOpzionali() {
        super();
